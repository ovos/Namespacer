    ...
    ConsoleUsageProviderInterface
{
    ...
    public function getConsoleUsage(ConsoleAdapterInterface $console)
    {
        ...
        return array(
            'Basic information:',
            'map --mapfile <file> --source <sourcedir> --ignore <comma-separated-paths> --no-dir-namespacing --merge' => 'create a map in file <file> from <source>',
            'transform --mapfile <file> --source <sourcedir> --no-file-docblocks --no-namespace-no-use' => 'transform the files in the map',
